...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['file_surat']) && $_FILES['file_surat']['error'] === 0 && !empty($_FILES['file_surat']['tmp_name'])) {
        ...
        if (!in_array($file['type'], $allowed_types) || $file['size'] > 2 * 1024 * 1024) {
            header("Location: tambah_surat_masuk.php?gagal=" . urlencode("Error: Cek kembali format (JPG, PNG, PDF, DOC, DOCX) dan ukuran file (Maks 2MB)."));
            exit;
        } else {
            ...
            if (!move_uploaded_file($file['tmp_name'], $target_file)) {
                header("Location: tambah_surat_masuk.php?gagal=" . urlencode("Error: Gagal memindahkan file. Periksa izin folder."));
                exit;
            }
        }
    }
    ...
    try {
        ...
        header("Location: screen_surat_masuk.php?sukses=Data surat masuk berhasil disimpan!");
        exit;
    } catch (PDOException $e) {
        header("Location: tambah_surat_masuk.php?gagal=" . urlencode("Database Error: " . $e->getMessage()));
        exit;
    }
}
...
<div class="container-fluid px-4">
    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            ...
            <b>Formulir Tambah Data Surat Masuk</b>
        </div>
        <div class="card-body">
            ...
            <form action="tambah_surat_masuk.php" method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                Format: *.JPG, *.PNG, *.DOC, *.DOCX, *.PDF. Ukuran maks: <strong>2 MB</strong>.
                            </div>
                        </div>
                    </div>
                </div>
