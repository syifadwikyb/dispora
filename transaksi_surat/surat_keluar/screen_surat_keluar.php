...
if (!empty($search_keyword)) {
    $sql .= " WHERE nomor_surat LIKE ? OR tujuan LIKE ? OR isi_ringkas LIKE ? OR nomor_agenda LIKE ?";
                ...
                <div class="col-md-8">
                    <form action="" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cari berdasarkan no. surat, tujuan..." name="search" value="<?= htmlspecialchars($search_keyword) ?>">
                            ...
                            <?php foreach ($surat_list as $surat): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="edit_surat_keluar.php?id=<?= $surat['id_surat_keluar'] ?>" class="btn btn-sm btn-warning m-1" title="Edit">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <a href="hapus_surat_keluar.php?id=<?= $surat['id_surat_keluar'] ?>" class="btn btn-sm btn-danger m-1" title="Delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
