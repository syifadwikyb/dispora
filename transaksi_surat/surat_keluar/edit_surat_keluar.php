...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        header("Location: screen_surat_keluar.php?sukses=Data surat keluar berhasil diperbarui!");
        exit;

    } catch (PDOException $e) {
        header("Location: edit_surat_keluar.php?id={$id_surat}&gagal=" . urlencode("Update Gagal: " . $e->getMessage()));
        exit;
    }
}
...
if (isset($_GET['gagal'])) {
    $message = '<div class="alert alert-danger">' . htmlspecialchars(urldecode($_GET['gagal'])) . '</div>';
}
...
<div class="container-fluid px-4">
    ...
    <div class="card">
        <div class="card-header bg-warning">
            ...
            <b>Formulir Edit Data Surat Keluar</b>
        </div>
        <div class="card-body">
            
            <?php if(!empty($message)) echo $message; ?>

            <form action="edit_surat_keluar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($surat['nama_file'])): ?>
                                <div class="form-text">
                                    File saat ini: <a href="/ams/transaksi_surat/surat_keluar/file_keluar/<?= htmlspecialchars($surat['nama_file']) ?>" target="_blank"><?= htmlspecialchars($surat['nama_file']) ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="text-end">
                    ...
                    <a href="screen_surat_keluar.php" class="btn btn-secondary">
