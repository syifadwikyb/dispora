...
$sql = "SELECT nomor_agenda, kode_klasifikasi, isi_ringkas, asal_surat, nomor_surat, tanggal_surat, tanggal_diterima, keterangan 
        FROM surat_masuk 
        WHERE DATE(tanggal_diterima) BETWEEN ? AND ? 
...
<div class="container-fluid px-4" id="main-content">
    <h1 class="mt-4">Buku Agenda Surat Masuk</h1>
                        ...
                        <?php else: ?>
                            ...
                            <?php foreach ($agendas as $agenda): ?>
                                <tr class="text-center align-middle">
                                    ...
                                    <td><?= htmlspecialchars($agenda['isi_ringkas']) ?></td>
                                    <td><?= htmlspecialchars($agenda['asal_surat']) ?></td>
                                    ...
                                    <td><?= date('d-m-Y', strtotime($agenda['tanggal_surat'])) ?></td>
                                    <td><?= htmlspecialchars($agenda['keterangan']) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
